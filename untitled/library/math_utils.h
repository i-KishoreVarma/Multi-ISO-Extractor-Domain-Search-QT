...
public:
	...
	inline const Matrix4f & InitIdentity() {
		m[0][0] = 1.0f;
		m[0][1] = 0.0f;
		m[0][2] = 0.0f;
		m[0][3] = 0.0f;
	...
	const Matrix4f & InitScaleTransform(float ScaleX, float ScaleY, float ScaleZ) {
		m[0][0] = ScaleX;
		m[0][1] = 0.0f;
		m[0][2] = 0.0f;
		m[0][3] = 0.0f;
	...
	const Matrix4f & InitRotateTransform(float RotateX, float RotateY, float RotateZ) {
		Matrix4f rx, ry, rz;
	...
	const Matrix4f & InitAxisRotateTransform(const Vector3f& axis, float angle) {
	...
	const Matrix4f & InitTranslationTransform(float x, float y, float z) {
		m[0][0] = 1.0f;
		m[0][1] = 0.0f;
		m[0][2] = 0.0f;
		m[0][3] = x;
